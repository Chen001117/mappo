...
do
    ...
    --num_env_steps 1000000000 --ppo_epoch 5 --entropy_coef 0.01 --use_eval --n_eval_rollout_threads 16 \
    --wandb_name "cwz19" --user_name "cwz19" --data_chunk_length 16 --lr 1e-5 --critic_lr 1e-5 
    # --model_dir "results/${env}/${scenario}/${algo}/check/wandb/latest-run/files"
done
