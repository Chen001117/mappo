...
do
    ...
    --critic_hidden_size 128 --data_chunk_length 8 --lr 1e-5 --critic_lr 1e-5 \
    --wandb_name "cwz19" --user_name "cwz19" 
    # --model_dir "results/MuJoCo/Walker2d-v3/rmappo/check6/wandb/run-20230608_154452-233k5gah/files"
done
