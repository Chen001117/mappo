...
do
    ...
    --critic_hidden_size 128 --data_chunk_length 8 --lr 3e-5 --critic_lr 3e-5 \
    --wandb_name "cwz19" --user_name "cwz19" \
    --model_dir "results/MuJoCo/Walker2d-v3/rmappo/check/wandb/run-20240102_100933-3fymgk1s/files"  
    --model_dir "results/backup"  
    --model_dir "results/MuJoCo/Walker2d-v3/rmappo/check/wandb/run-20231225_214904-1flxl1ai/files"  
done
