...
CUDA_VISIBLE_DEVICES=1 python3 train/train_mujoco.py --env_name ${env} \
    ...
    --num_mini_batch 64 --episode_length 64 --use_ReLU --num_env_steps 1000000000 \
    ...
    --model_dir "results/MuJoCo/Walker2d-v3/rmappo/check/wandb/run-20240303_074234-2ouwxq9s/files" 
done
